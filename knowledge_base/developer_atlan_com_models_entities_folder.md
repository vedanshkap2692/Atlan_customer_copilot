# Folder¶
(source: https://developer.atlan.com/models/entities/folder/)
...
Query organizationQuery organizationNamespaceCollectionFolderFolderTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)childrenFolders (Folder)childrenQueries (Query)parent (Namespace)

Namespace

Collection

FolderFolderTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)childrenFolders (Folder)childrenQueries (Query)parent (Namespace)

__
...
This is a complete reference for theFolderobject in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:
...
Folderinherits its attributes and relationships from these other types:
...
These attributes are inherited fromFolder's supertypes (shown above):
...
These attributes are specific to instances ofFolder(and all of its subtypes).
...
These relationships are inherited fromFolder's supertypes:
...
These relationships are specific to instances ofFolder(and all of its subtypes).
