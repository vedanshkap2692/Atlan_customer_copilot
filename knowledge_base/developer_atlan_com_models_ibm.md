# IBMIBM model¶
(source: https://developer.atlan.com/models/ibm/)
...
This is reference documentation covering the entire Atlan model. It isnotthe best place to start when trying to understand integrating IBM assets with Atlan. For that, we would suggest starting with either:
