...
(source: https://developer.atlan.com/models/entities/microstrategyproject/)
...
MicroStrategyMicroStrategyMicroStrategyAttributeMicroStrategyCubeMicroStrategyDocumentMicroStrategyDossierMicroStrategyFactMicroStrategyMetricMicroStrategyProjectMicroStrategyProjectTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)microStrategyAttributes (MicroStrategyAttribute)microStrategyCubes (MicroStrategyCube)microStrategyDocuments (MicroStrategyDocument)microStrategyDossiers (MicroStrategyDossier)microStrategyFacts (MicroStrategyFact)microStrategyMetrics (MicroStrategyMetric)microStrategyReports (MicroStrategyReport)microStrategyVisualizations (MicroStrategyVisualization)MicroStrategyReportMicroStrategyVisualization
...
MicroStrategyProjectMicroStrategyProjectTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)microStrategyAttributes (MicroStrategyAttribute)microStrategyCubes (MicroStrategyCube)microStrategyDocuments (MicroStrategyDocument)microStrategyDossiers (MicroStrategyDossier)microStrategyFacts (MicroStrategyFact)microStrategyMetrics (MicroStrategyMetric)microStrategyReports (MicroStrategyReport)microStrategyVisualizations (MicroStrategyVisualization)

__
...
microStrategyDocuments (MicroStrategyDocument)

microStrategyDossiers (MicroStrategyDossier)
...
microStrategyVisualizations (MicroStrategyVisualization)
...
This is a complete reference for theMicroStrategyProjectobject in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:
...
MicroStrategyProjectinherits its attributes and relationships from these other types:
...
These attributes are inherited fromMicroStrategyProject's supertypes (shown above):
...
These relationships are inherited fromMicroStrategyProject's supertypes:
...
These relationships are specific to instances ofMicroStrategyProject(and all of its subtypes).
