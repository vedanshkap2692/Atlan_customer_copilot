# Kafka¶
(source: https://developer.atlan.com/models/kafka/)
...
This is reference documentation covering the entire Atlan model. It isnotthe best place to start when trying to understand managing Kafka assets in Atlan. For that, we would suggest starting with either:
