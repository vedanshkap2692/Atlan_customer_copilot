# MicroStrategy¶
(source: https://developer.atlan.com/models/microstrategy/)
...

...
This is reference documentation covering the entire Atlan model. It isnotthe best place to start when trying to understand managing MicroStrategy assets in Atlan. For that, we would suggest starting with either:
...
These attributes are specific to instances ofMicroStrategy(and all of its subtypes).
