# Domo¶
(source: https://developer.atlan.com/models/domo/)
...
This is reference documentation covering the entire Atlan model. It isnotthe best place to start when trying to understand how to manage Domo assets in Atlan. For that, we would suggest starting with either:
...
These attributes are specific to instances ofDomo(and all of its subtypes).
