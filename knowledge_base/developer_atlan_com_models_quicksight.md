# QuickSight model¶
(source: https://developer.atlan.com/models/quicksight/)
...
PropertiesquickSightIdquickSightSheetIdquickSightSheetName
...
This is reference documentation covering the entire Atlan model. It isnotthe best place to start when trying to understand how to manage QuickSight assets in Atlan. For that, we would suggest starting with either:
...
These attributes are specific to instances ofQuickSight(and all of its subtypes).
