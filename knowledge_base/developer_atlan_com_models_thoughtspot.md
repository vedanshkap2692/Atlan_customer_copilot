# Thoughtspot¶
(source: https://developer.atlan.com/models/thoughtspot/)
...
PropertiesthoughtspotChartTypethoughtspotColumnCountthoughtspotJoinCountthoughtspotQuestionText
...
This is reference documentation covering the entire Atlan model. It isnotthe best place to start when trying to understand managing ThoughtSpot assets in Atlan. For that, we would suggest starting with either:
...
These attributes are specific to instances ofThoughtspot(and all of its subtypes).
