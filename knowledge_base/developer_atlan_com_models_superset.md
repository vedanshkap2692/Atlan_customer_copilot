# Superset¶
(source: https://developer.atlan.com/models/superset/)
...
PropertiessupersetDashboardIdsupersetDashboardQualifiedName
...
This is reference documentation covering the entire Atlan model. It isnotthe best place to start when trying to understand managing Superset assets in Atlan. For that, we would suggest starting with themanage Superset assets pattern.
...
These attributes are specific to instances ofSuperset(and all of its subtypes).
