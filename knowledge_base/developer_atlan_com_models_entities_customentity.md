# CustomEntity¶
(source: https://developer.atlan.com/models/entities/customentity/)
...
CustomCustomCustomEntityCustomEntityTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)customChildEntities (CustomEntity)customParentEntity (CustomEntity)customRelatedFromEntities (CustomEntity)customRelatedToEntities (CustomEntity)

CustomEntityCustomEntityTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)customChildEntities (CustomEntity)customParentEntity (CustomEntity)customRelatedFromEntities (CustomEntity)customRelatedToEntities (CustomEntity)
...
customChildEntities (CustomEntity)

customParentEntity (CustomEntity)

customRelatedFromEntities (CustomEntity)

customRelatedToEntities (CustomEntity)
...
This is a complete reference for theCustomEntityobject in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:
...
CustomEntityinherits its attributes and relationships from these other types:
...
These attributes are inherited fromCustomEntity's supertypes (shown above):
...
These relationships are inherited fromCustomEntity's supertypes:
...
These relationships are specific to instances ofCustomEntity(and all of its subtypes).
