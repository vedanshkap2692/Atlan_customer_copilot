...
(source: https://developer.atlan.com/snippets/datacontract/)
...
Data contractsare agreements between data producers and consumers, that specify requirements for generating and using high-quality, reliable data.

You canmanage data contractsusing Atlan'scommand-line interface (CLI).

You may also want to refer to thedata contracts specification, to understand how data contracts are defined.
