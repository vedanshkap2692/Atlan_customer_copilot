# API model¶
(source: https://developer.atlan.com/models/api/)
...
PropertiesapiExternalDocsapiIsAuthOptionalapiIsObjectReferenceapiObjectQualifiedNameapiSpecNameapiSpecQualifiedNameapiSpecTypeapiSpecVersion
...
This is reference documentation covering the entire Atlan model. It isnotthe best place to start when trying to understand how to manage API assets in Atlan. For that, we would suggest starting with themanage API assets pattern.
...
These attributes are specific to instances ofAPI(and all of its subtypes).
