# Fivetran model¶
(source: https://developer.atlan.com/models/fivetran/)
...
PropertiesfivetranLastSyncRecordsUpdatedfivetranLastSyncStatusfivetranWorkflowName
...
This is reference documentation covering the entire Atlan model. It isnotthe best place to start when trying to understand how to manage Anomalo assets.
...
These attributes are unique to instances ofFivetran(and all of its subtypes).
