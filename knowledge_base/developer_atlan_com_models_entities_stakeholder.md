# Stakeholder¶
(source: https://developer.atlan.com/models/entities/stakeholder/)
...
Data meshData meshDataDomainDataProductDataContractStakeholderStakeholderTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)policies (AuthPolicy)stakeholderDataDomain (DataDomain)stakeholderTitle (StakeholderTitle)StakeholderTitle
...
StakeholderStakeholderTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)policies (AuthPolicy)stakeholderDataDomain (DataDomain)stakeholderTitle (StakeholderTitle)

__
...
stakeholderDataDomain (DataDomain)
...
This is a complete reference for theStakeholderobject in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:
...
Stakeholderinherits its attributes and relationships from these other types:
...
These attributes are inherited fromStakeholder's supertypes (shown above):
...
These attributes are specific to instances ofStakeholder(and all of its subtypes).
...
These relationships are inherited fromStakeholder's supertypes:
...
These relationships are specific to instances ofStakeholder(and all of its subtypes).
