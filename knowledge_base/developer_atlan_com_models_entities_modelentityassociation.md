...
(source: https://developer.atlan.com/models/entities/modelentityassociation/)
...
ModelsModelsModelAttributeModelAttributeAssociationModelDataModelModelEntityModelEntityAssociationModelEntityAssociationTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)modelEntityAssociationFrom (ModelEntity)modelEntityAssociationTo (ModelEntity)ModelVersion
...
ModelEntityAssociationModelEntityAssociationTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)modelEntityAssociationFrom (ModelEntity)modelEntityAssociationTo (ModelEntity)

__
...
modelEntityAssociationFrom (ModelEntity)

modelEntityAssociationTo (ModelEntity)
...
This is a complete reference for theModelEntityAssociationobject in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:
...
ModelEntityAssociationinherits its attributes and relationships from these other types:
...
These attributes are inherited fromModelEntityAssociation's supertypes (shown above):
...
These attributes are specific to instances ofModelEntityAssociation(and all of its subtypes).
...
These relationships are inherited fromModelEntityAssociation's supertypes:
...
These relationships are specific to instances ofModelEntityAssociation(and all of its subtypes).
