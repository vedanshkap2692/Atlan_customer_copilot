...
(source: https://developer.atlan.com/models/entities/databricksunitycatalogtag/)
...
Relational databasesRelational databasesDatabaseSchemaTableViewMaterialisedViewColumnQueryTablePartitionCalculationViewBigqueryTagDatabricksUnityCatalogTagDatabricksUnityCatalogTagTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)dbtModels (DbtModel)dbtSources (DbtSource)dbtTests (DbtTest)sqlDBTSources (DbtSource)sqlDbtModels (DbtModel)SnowflakeDynamicTableSnowflakePipeSnowflakeStreamSnowflakeTagProcedureFunctionSQL
...
This is a complete reference for theDatabricksUnityCatalogTagobject in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:
...
DatabricksUnityCatalogTaginherits its attributes and relationships from these other types:
...
These attributes are inherited fromDatabricksUnityCatalogTag's supertypes (shown above):
...
These relationships are inherited fromDatabricksUnityCatalogTag's supertypes:
