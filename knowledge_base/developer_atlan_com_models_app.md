# App model¶
(source: https://developer.atlan.com/models/app/)
...
This is reference documentation covering the entire Atlan model. It isnotthe best place to start when trying to understand how to manage App assets in Atlan. For that, we would suggest starting with themanage App assets pattern.
...
These attributes are specific to instances ofApp(and all of its subtypes).
