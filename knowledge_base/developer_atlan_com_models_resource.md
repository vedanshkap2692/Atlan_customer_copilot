# Resources model¶
(source: https://developer.atlan.com/models/resource/)
...
PropertiesisGloballinkreferenceresourceMetadata
...
This is reference documentation covering the entire Atlan model. It isnotthe best place to start when trying to understand how to manage resources in Atlan. For that, we would suggest starting with either:

theadd asset resources / links snippets

themanage file assets pattern
...
These attributes are specific to instances ofResource(and all of its subtypes).
