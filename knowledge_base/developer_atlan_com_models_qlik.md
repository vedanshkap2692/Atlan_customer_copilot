# Qlik¶
(source: https://developer.atlan.com/models/qlik/)
...
PropertiesqlikAppIdqlikAppQualifiedNameqlikIdqlikIsPublishedqlikOwnerIdqlikQRIqlikSpaceIdqlikSpaceQualifiedName
...
This is reference documentation covering the entire Atlan model. It isnotthe best place to start when trying to understand managing Qlik assets in Atlan. For that, we would suggest starting with either:
...
These attributes are specific to instances ofQlik(and all of its subtypes).
