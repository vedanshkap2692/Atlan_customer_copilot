# CognosFolder¶
(source: https://developer.atlan.com/models/entities/cognosfolder/)
...
IBMIBMIBMCognosCognosCognosDashboardCognosDatasourceCognosExplorationCognosFileCognosFolderCognosFolderTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)cognosDashboards (CognosDashboard)cognosExplorations (CognosExploration)cognosFiles (CognosFile)cognosFolder (CognosFolder)cognosModules (CognosModule)cognosPackages (CognosPackage)cognosReports (CognosReport)cognosSubFolders (CognosFolder)CognosModuleCognosPackageCognosReport

CognosCognosCognosDashboardCognosDatasourceCognosExplorationCognosFileCognosFolderCognosFolderTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)cognosDashboards (CognosDashboard)cognosExplorations (CognosExploration)cognosFiles (CognosFile)cognosFolder (CognosFolder)cognosModules (CognosModule)cognosPackages (CognosPackage)cognosReports (CognosReport)cognosSubFolders (CognosFolder)CognosModuleCognosPackageCognosReport
...
CognosFolderCognosFolderTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)cognosDashboards (CognosDashboard)cognosExplorations (CognosExploration)cognosFiles (CognosFile)cognosFolder (CognosFolder)cognosModules (CognosModule)cognosPackages (CognosPackage)cognosReports (CognosReport)cognosSubFolders (CognosFolder)

__
...
cognosDashboards (CognosDashboard)

cognosExplorations (CognosExploration)

cognosFiles (CognosFile)

cognosFolder (CognosFolder)

cognosModules (CognosModule)

cognosPackages (CognosPackage)

cognosReports (CognosReport)

cognosSubFolders (CognosFolder)
...
This is a complete reference for theCognosFolderobject in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:
...
CognosFolderinherits its attributes and relationships from these other types:
...
These attributes are inherited fromCognosFolder's supertypes (shown above):
...
These attributes are specific to instances ofCognosFolder(and all of its subtypes).
...
These relationships are inherited fromCognosFolder's supertypes:
...
These relationships are specific to instances ofCognosFolder(and all of its subtypes).
