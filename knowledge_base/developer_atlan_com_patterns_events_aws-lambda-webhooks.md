# Handlingwebhooks viaAWS Lambda¶
(source: https://developer.atlan.com/patterns/events/aws-lambda-webhooks/)
...
Set up an AWS Lambda functionthat can receive webhooks from Atlan.

Code your logicfor handling the events.

Deploy your codeto the AWS Lambda function.

Set up an Atlan webhookto call the AWS Lambda function.

You can alsomanageyour code on an ongoing basis.
