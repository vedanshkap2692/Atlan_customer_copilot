# Cube model¶
(source: https://developer.atlan.com/models/multidimensionaldataset/)
...
PropertiescubeDimensionNamecubeDimensionQualifiedNamecubeHierarchyNamecubeHierarchyQualifiedNamecubeNamecubeQualifiedName
...
This is reference documentation covering the entire Atlan model. It isnotthe best place to start when trying to understand how to manage multidimensional cube assets in Atlan. For that, we would suggest starting with themanage cube assets pattern.
...
These attributes are specific to instances ofMultiDimensionalDataset(and all of its subtypes).
