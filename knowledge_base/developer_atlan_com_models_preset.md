# Preset¶
(source: https://developer.atlan.com/models/preset/)
...
PropertiespresetDashboardIdpresetDashboardQualifiedNamepresetWorkspaceIdpresetWorkspaceQualifiedName
...
This is reference documentation covering the entire Atlan model. It isnotthe best place to start when trying to understand managing Preset assets in Atlan. For that, we would suggest starting with themanage Preset assets pattern.
...
These attributes are specific to instances ofPreset(and all of its subtypes).
