# Dataverse¶
(source: https://developer.atlan.com/models/dataverse/)
...
PropertiesdataverseIsAuditEnableddataverseIsCustomdataverseIsCustomizable
...
This is a complete reference for theDataverseobject in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:
...
Dataverseinherits its attributes and relationships from these other types:
...
These attributes are specific to instances ofDataverse(and all of its subtypes).
