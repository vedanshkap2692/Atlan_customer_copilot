# LookerProject¶
(source: https://developer.atlan.com/models/entities/lookerproject/)
...
LookerLookerLookerDashboardLookerExploreLookerFieldLookerFolderLookerLookLookerModelLookerProjectLookerProjectTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)explores (LookerExplore)fields (LookerField)lookerChildProjects (LookerProject)lookerParentProjects (LookerProject)models (LookerModel)views (LookerView)LookerQueryLookerTileLookerView
...
LookerProjectLookerProjectTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)explores (LookerExplore)fields (LookerField)lookerChildProjects (LookerProject)lookerParentProjects (LookerProject)models (LookerModel)views (LookerView)
...
lookerChildProjects (LookerProject)

lookerParentProjects (LookerProject)
...
This is a complete reference for theLookerProjectobject in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:
...
LookerProjectinherits its attributes and relationships from these other types:
...
These attributes are inherited fromLookerProject's supertypes (shown above):
...
These relationships are inherited fromLookerProject's supertypes:
...
These relationships are specific to instances ofLookerProject(and all of its subtypes).
