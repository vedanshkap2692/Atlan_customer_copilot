# DomoDashboard¶
(source: https://developer.atlan.com/models/entities/domodashboard/)
...
DomoDomoDomoCardDomoDashboardDomoDashboardTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)domoCards (DomoCard)domoDashboardChildren (DomoDashboard)domoDashboardParent (DomoDashboard)DomoDatasetDomoDatasetColumn

DomoCard

DomoDashboardDomoDashboardTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)domoCards (DomoCard)domoDashboardChildren (DomoDashboard)domoDashboardParent (DomoDashboard)

__
...
domoDashboardChildren (DomoDashboard)

domoDashboardParent (DomoDashboard)
...
This is a complete reference for theDomoDashboardobject in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:
...
DomoDashboardinherits its attributes and relationships from these other types:
...
These attributes are inherited fromDomoDashboard's supertypes (shown above):
...
These attributes are specific to instances ofDomoDashboard(and all of its subtypes).
...
These relationships are inherited fromDomoDashboard's supertypes:
...
These relationships are specific to instances ofDomoDashboard(and all of its subtypes).
