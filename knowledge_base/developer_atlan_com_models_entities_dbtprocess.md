# DbtProcess¶
(source: https://developer.atlan.com/models/entities/dbtprocess/)
...
dbtdbtDbtColumnProcessDbtMetricDbtModelDbtModelColumnDbtProcessDbtProcessTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)adfActivity (AdfActivity)airflowTasks (AirflowTask)columnProcesses (ColumnProcess)fivetranConnector (FivetranConnector)inputs (Catalog)matillionComponent (MatillionComponent)outputs (Catalog)powerBIDataflow (PowerBIDataflow)sparkJobs (SparkJob)DbtSourceDbtTagDbtTest
...
DbtProcessDbtProcessTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)adfActivity (AdfActivity)airflowTasks (AirflowTask)columnProcesses (ColumnProcess)fivetranConnector (FivetranConnector)inputs (Catalog)matillionComponent (MatillionComponent)outputs (Catalog)powerBIDataflow (PowerBIDataflow)sparkJobs (SparkJob)

__
...
This is a complete reference for theDbtProcessobject in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:
...
DbtProcessinherits its attributes and relationships from these other types:
...
These attributes are inherited fromDbtProcess's supertypes (shown above):
...
These attributes are specific to instances ofDbtProcess(and all of its subtypes).
...
These relationships are inherited fromDbtProcess's supertypes:
