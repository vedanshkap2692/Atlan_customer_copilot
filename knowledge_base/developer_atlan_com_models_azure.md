# Azure¶
(source: https://developer.atlan.com/models/azure/)
...
PropertiesadlsAccountSecondaryLocationazureLocationazureResourceIdazureTags
...
These attributes are specific to instances ofAzure(and all of its subtypes).
