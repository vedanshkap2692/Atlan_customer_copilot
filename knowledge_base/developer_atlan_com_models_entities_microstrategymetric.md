# MicroStrategyMetric¶
(source: https://developer.atlan.com/models/entities/microstrategymetric/)
...
MicroStrategyMicroStrategyMicroStrategyAttributeMicroStrategyCubeMicroStrategyDocumentMicroStrategyDossierMicroStrategyFactMicroStrategyMetricMicroStrategyMetricTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)microStrategyAttributes (MicroStrategyAttribute)microStrategyCubes (MicroStrategyCube)microStrategyFacts (MicroStrategyFact)microStrategyMetricChildren (MicroStrategyMetric)microStrategyMetricParents (MicroStrategyMetric)microStrategyProject (MicroStrategyProject)microStrategyReports (MicroStrategyReport)MicroStrategyProjectMicroStrategyReportMicroStrategyVisualization
...
MicroStrategyMetricMicroStrategyMetricTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)microStrategyAttributes (MicroStrategyAttribute)microStrategyCubes (MicroStrategyCube)microStrategyFacts (MicroStrategyFact)microStrategyMetricChildren (MicroStrategyMetric)microStrategyMetricParents (MicroStrategyMetric)microStrategyProject (MicroStrategyProject)microStrategyReports (MicroStrategyReport)

__
...
microStrategyAttributes (MicroStrategyAttribute)

microStrategyCubes (MicroStrategyCube)

microStrategyFacts (MicroStrategyFact)

microStrategyMetricChildren (MicroStrategyMetric)

microStrategyMetricParents (MicroStrategyMetric)

microStrategyProject (MicroStrategyProject)

microStrategyReports (MicroStrategyReport)
...
This is a complete reference for theMicroStrategyMetricobject in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:
...
MicroStrategyMetricinherits its attributes and relationships from these other types:
...
These attributes are inherited fromMicroStrategyMetric's supertypes (shown above):
...
These attributes are specific to instances ofMicroStrategyMetric(and all of its subtypes).
...
These relationships are inherited fromMicroStrategyMetric's supertypes:
...
These relationships are specific to instances ofMicroStrategyMetric(and all of its subtypes).
