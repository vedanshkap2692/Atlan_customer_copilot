# Cognos¶
(source: https://developer.atlan.com/models/cognos/)
...
PropertiescognosDefaultScreenTipcognosIdcognosIsDisabledcognosIsHiddencognosParentNamecognosParentQualifiedNamecognosPathcognosTypecognosVersion
...
This is reference documentation covering the entire Atlan model. It isnotthe best place to start when trying to understand how to manage Cognos assets in Atlan. For that, we would suggest starting with either:
...
These attributes are specific to instances ofCognos(and all of its subtypes).
