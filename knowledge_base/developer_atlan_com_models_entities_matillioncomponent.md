# MatillionComponent¶
(source: https://developer.atlan.com/models/entities/matillioncomponent/)
...
MatillionMatillionMatillionComponentMatillionComponentTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)matillionJob (MatillionJob)matillionProcess (Process)MatillionGroupMatillionJobMatillionProject

MatillionComponentMatillionComponentTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)matillionJob (MatillionJob)matillionProcess (Process)

__
...
matillionJob (MatillionJob)

matillionProcess (Process)
...
This is a complete reference for theMatillionComponentobject in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:
...
MatillionComponentinherits its attributes and relationships from these other types:
...
These attributes are inherited fromMatillionComponent's supertypes (shown above):
...
These attributes are specific to instances ofMatillionComponent(and all of its subtypes).
...
These relationships are inherited fromMatillionComponent's supertypes:
...
These relationships are specific to instances ofMatillionComponent(and all of its subtypes).
