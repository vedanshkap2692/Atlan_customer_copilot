# DataContract¶
(source: https://developer.atlan.com/models/entities/datacontract/)
...
Data meshData meshDataDomainDataProductDataContractDataContractTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)dataContractAssetCertified (Asset)dataContractAssetLatest (Asset)dataContractNextVersion (DataContract)dataContractPreviousVersion (DataContract)StakeholderStakeholderTitle

DataDomain

DataProduct

DataContractDataContractTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)dataContractAssetCertified (Asset)dataContractAssetLatest (Asset)dataContractNextVersion (DataContract)dataContractPreviousVersion (DataContract)

__
...
dataContractAssetCertified (Asset)

dataContractAssetLatest (Asset)

dataContractNextVersion (DataContract)
...
This is a complete reference for theDataContractobject in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:
...
DataContractinherits its attributes and relationships from these other types:
...
These attributes are inherited fromDataContract's supertypes (shown above):
...
These attributes are specific to instances ofDataContract(and all of its subtypes).
...
These relationships are inherited fromDataContract's supertypes:
...
These relationships are specific to instances ofDataContract(and all of its subtypes).
