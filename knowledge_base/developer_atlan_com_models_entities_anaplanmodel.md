# AnaplanModel¶
(source: https://developer.atlan.com/models/entities/anaplanmodel/)
...
AnaplanAnaplanAnaplanWorkspaceAnaplanAppAnaplanPageAnaplanModelAnaplanModelTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)anaplanDimensions (AnaplanDimension)anaplanLists (AnaplanList)anaplanModules (AnaplanModule)anaplanPages (AnaplanPage)anaplanWorkspace (AnaplanWorkspace)AnaplanModuleAnaplanListAnaplanSystemDimensionAnaplanDimensionAnaplanLineItemAnaplanView
...
AnaplanModelAnaplanModelTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)anaplanDimensions (AnaplanDimension)anaplanLists (AnaplanList)anaplanModules (AnaplanModule)anaplanPages (AnaplanPage)anaplanWorkspace (AnaplanWorkspace)

__
...
anaplanDimensions (AnaplanDimension)

anaplanLists (AnaplanList)

anaplanModules (AnaplanModule)

anaplanPages (AnaplanPage)
...
This is a complete reference for theAnaplanModelobject in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:
...
AnaplanModelinherits its attributes and relationships from these other types:
...
These attributes are inherited fromAnaplanModel's supertypes (shown above):
...
These relationships are inherited fromAnaplanModel's supertypes:
...
These relationships are specific to instances ofAnaplanModel(and all of its subtypes).
