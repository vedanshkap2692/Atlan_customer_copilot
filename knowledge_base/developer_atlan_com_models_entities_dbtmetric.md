# DbtMetric¶
(source: https://developer.atlan.com/models/entities/dbtmetric/)
...
dbtdbtDbtColumnProcessDbtMetricDbtMetricTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)assets (Asset)metricDimensionColumns (Column)metricTimestampColumn (Column)dbtMetricFilterColumns (Column)dbtModel (DbtModel)DbtModelDbtModelColumnDbtProcessDbtSourceDbtTagDbtTest

DbtColumnProcess

DbtMetricDbtMetricTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)assets (Asset)metricDimensionColumns (Column)metricTimestampColumn (Column)dbtMetricFilterColumns (Column)dbtModel (DbtModel)

__
...
metricDimensionColumns (Column)

metricTimestampColumn (Column)

dbtMetricFilterColumns (Column)
...
This is a complete reference for theDbtMetricobject in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:
...
DbtMetricinherits its attributes and relationships from these other types:
...
These attributes are inherited fromDbtMetric's supertypes (shown above):
...
These attributes are specific to instances ofDbtMetric(and all of its subtypes).
...
These relationships are inherited fromDbtMetric's supertypes:
...
These relationships are specific to instances ofDbtMetric(and all of its subtypes).
