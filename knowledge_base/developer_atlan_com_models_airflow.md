...
(source: https://developer.atlan.com/models/airflow/)
...
PropertiesairflowRunEndTimeairflowRunNameairflowRunOpenLineageStateairflowRunOpenLineageVersionairflowRunStartTimeairflowRunTypeairflowRunVersionairflowTags
...
This is reference documentation covering the entire Atlan model. It isnotthe best place to start when trying to understand developing with Atlan. For that, we would suggest starting with either:
...
These attributes are specific to instances ofAirflow(and all of its subtypes).
