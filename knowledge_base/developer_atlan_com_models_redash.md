# Redash¶
(source: https://developer.atlan.com/models/redash/)
...
This is reference documentation covering the entire Atlan model. It isnotthe best place to start when trying to understand managing Redash assets in Atlan. For that, we would suggest starting with either:
...
These attributes are specific to instances ofRedash(and all of its subtypes).
