# Mode¶
(source: https://developer.atlan.com/models/mode/)
...
PropertiesmodeIdmodeQueryNamemodeQueryQualifiedNamemodeReportNamemodeReportQualifiedNamemodeTokenmodeWorkspaceNamemodeWorkspaceQualifiedNamemodeWorkspaceUsername
...
This is reference documentation covering the entire Atlan model. It isnotthe best place to start when trying to understand managing Mode assets in Atlan. For that, we would suggest starting with either:
...
These attributes are specific to instances ofMode(and all of its subtypes).
