...
We will want some inputs to configure the package, such as:The JSON containing the API definitionsWhether to load these into a new connection or reuse an existing connectionThe details for the connection (whether new or existing)
...
And we will want to provide some general information about the package itself, such as:It's nameAn iconWhere it's documented
