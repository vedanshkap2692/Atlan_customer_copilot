# LookerFolder¶
(source: https://developer.atlan.com/models/entities/lookerfolder/)
...
LookerLookerLookerDashboardLookerExploreLookerFieldLookerFolderLookerFolderTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)dashboards (LookerDashboard)lookerParentFolder (LookerFolder)lookerSubFolders (LookerFolder)looks (LookerLook)LookerLookLookerModelLookerProjectLookerQueryLookerTileLookerView
...
LookerFolderLookerFolderTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)dashboards (LookerDashboard)lookerParentFolder (LookerFolder)lookerSubFolders (LookerFolder)looks (LookerLook)

__
...
lookerParentFolder (LookerFolder)

lookerSubFolders (LookerFolder)
...
This is a complete reference for theLookerFolderobject in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:
...
LookerFolderinherits its attributes and relationships from these other types:
...
These attributes are inherited fromLookerFolder's supertypes (shown above):
...
These attributes are specific to instances ofLookerFolder(and all of its subtypes).
...
These relationships are inherited fromLookerFolder's supertypes:
...
These relationships are specific to instances ofLookerFolder(and all of its subtypes).
