...
(source: https://developer.atlan.com/patterns/events/aws-lambda-webhooks/managing/)
...
Event handlingEvent handlingWebhook <> LambdaWebhook <> LambdaSet up LambdaCode your logicDeploy your codeSet up webhookManage your webhookManage your webhookTable of contentsReviewing metricsReviewing logsUpdating the SDKUpdating your code

Webhook <> LambdaWebhook <> LambdaSet up LambdaCode your logicDeploy your codeSet up webhookManage your webhookManage your webhookTable of contentsReviewing metricsReviewing logsUpdating the SDKUpdating your code
...
Manage your webhookManage your webhookTable of contentsReviewing metricsReviewing logsUpdating the SDKUpdating your code
...
You can monitor the activity through theMonitortab of your function:

Open theAWS Lambda functions console.

From the list ofFunctions, click your function.

Change to theMonitortab.
...
Click theView CloudWatch logsbutton.

Under theLog streamstab, in theLog streamstable you will see all the logs created by events. You can click on any log stream in the table to view the detailed messages logged during event processing.
...
From the list ofLayers, click your layer containing the SDK you want to update.

In the upper-right, click theCreate versionbutton.

Click theUploadbutton to select the lambda-layer file for the SDK.

ForCompatible architecturesselectx86_64.

ForCompatible runtimesselect the latest version of the target language.

In the lower-right, click theCreatebutton.

Open theAWS Lambda functions console.

On theCodetab, scroll down toLayers.

In the upper-right of theLayerstable, click theEditbutton.

From theLayerstable, select the latest version of the layer you created underLayer version.
...
On theCodetab:JavaPythonIn the upper-right of theCode sourcetable, clickUpload fromand then.zip or .jar file.Use theUploadbutton to select the zip file containing your code.In the lower-right of the dialog click theSavebutton to deploy your new code.In theCode sourcetable you can either:(Recommended) Copy / paste the code from your new module (file) into the editor window forlambda_function.py.In the upper-right, clickUpload fromand choose the location of your code.Towards the middle of theCode sourcetable, click theDeploybutton to deploy your code.
...
In the lower-right of the dialog click theSavebutton to deploy your new code.
