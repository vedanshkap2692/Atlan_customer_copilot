# Column¶
(source: https://developer.atlan.com/models/entities/column/)
...
Relational databasesRelational databasesDatabaseSchemaTableViewMaterialisedViewColumnColumnTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)dbtModels (DbtModel)dbtSources (DbtSource)dbtTests (DbtTest)sqlDBTSources (DbtSource)sqlDbtModels (DbtModel)calculationView (CalculationView)columnDbtModelColumns (DbtModelColumn)cosmosMongoDBCollection (CosmosMongoDBCollection)dataQualityMetricDimensions (Metric)dbtMetrics (DbtMetric)dbtModelColumns (DbtModelColumn)foreignKeyFrom (Column)foreignKeyTo (Column)materialisedView (MaterialisedView)metricTimestamps (Metric)nestedColumns (Column)parentColumn (Column)queries (Query)snowflakeDynamicTable (SnowflakeDynamicTable)table (Table)tablePartition (TablePartition)view (View)QueryTablePartitionCalculationViewBigqueryTagDatabricksUnityCatalogTagSnowflakeDynamicTableSnowflakePipeSnowflakeStreamSnowflakeTagProcedureFunctionSQL
...
ColumnColumnTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)dbtModels (DbtModel)dbtSources (DbtSource)dbtTests (DbtTest)sqlDBTSources (DbtSource)sqlDbtModels (DbtModel)calculationView (CalculationView)columnDbtModelColumns (DbtModelColumn)cosmosMongoDBCollection (CosmosMongoDBCollection)dataQualityMetricDimensions (Metric)dbtMetrics (DbtMetric)dbtModelColumns (DbtModelColumn)foreignKeyFrom (Column)foreignKeyTo (Column)materialisedView (MaterialisedView)metricTimestamps (Metric)nestedColumns (Column)parentColumn (Column)queries (Query)snowflakeDynamicTable (SnowflakeDynamicTable)table (Table)tablePartition (TablePartition)view (View)

__
...
columnDbtModelColumns (DbtModelColumn)

cosmosMongoDBCollection (CosmosMongoDBCollection)

dataQualityMetricDimensions (Metric)

dbtMetrics (DbtMetric)

dbtModelColumns (DbtModelColumn)

foreignKeyFrom (Column)

foreignKeyTo (Column)

materialisedView (MaterialisedView)

metricTimestamps (Metric)
...
snowflakeDynamicTable (SnowflakeDynamicTable)
...
This is a complete reference for theColumnobject in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:
...
Columninherits its attributes and relationships from these other types:
...
These attributes are inherited fromColumn's supertypes (shown above):
...
These attributes are specific to instances ofColumn(and all of its subtypes).
...
These relationships are inherited fromColumn's supertypes:
...
These relationships are specific to instances ofColumn(and all of its subtypes).
...
Uses a different name in SDKsmaterializedViewmaterialized_view

Uses a different name in SDKs

materializedViewmaterialized_view
