# Anaplan¶
(source: https://developer.atlan.com/models/anaplan/)
...
PropertiesanaplanModelNameanaplanModelQualifiedNameanaplanModuleNameanaplanModuleQualifiedNameanaplanSourceIdanaplanWorkspaceNameanaplanWorkspaceQualifiedName
...
This is a complete reference for theAnaplanobject in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:
...
Anaplaninherits its attributes and relationships from these other types:
...
These attributes are specific to instances ofAnaplan(and all of its subtypes).
