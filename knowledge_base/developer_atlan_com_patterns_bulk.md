# Bulk updates¶
(source: https://developer.atlan.com/patterns/bulk/)
...
Make changes to multiple assets at the same time
...
To do this, there is acommon end-to-end bulk update patternyou can follow.
