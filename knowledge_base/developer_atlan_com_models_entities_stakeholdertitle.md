# StakeholderTitle¶
(source: https://developer.atlan.com/models/entities/stakeholdertitle/)
...
Data meshData meshDataDomainDataProductDataContractStakeholderStakeholderTitleStakeholderTitleTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)stakeholders (Stakeholder)
...
StakeholderTitleStakeholderTitleTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)stakeholders (Stakeholder)

__
...
This is a complete reference for theStakeholderTitleobject in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:
...
StakeholderTitleinherits its attributes and relationships from these other types:
...
These attributes are inherited fromStakeholderTitle's supertypes (shown above):
...
These attributes are specific to instances ofStakeholderTitle(and all of its subtypes).
...
These relationships are inherited fromStakeholderTitle's supertypes:
...
These relationships are specific to instances ofStakeholderTitle(and all of its subtypes).
