# Sigma¶
(source: https://developer.atlan.com/models/sigma/)
...
PropertiessigmaDataElementNamesigmaDataElementQualifiedNamesigmaPageNamesigmaPageQualifiedNamesigmaWorkbookNamesigmaWorkbookQualifiedName
...
This is reference documentation covering the entire Atlan model. It isnotthe best place to start when trying to understand managing Sigma assets in Atlan. For that, we would suggest starting with either:
...
These attributes are specific to instances ofSigma(and all of its subtypes).
