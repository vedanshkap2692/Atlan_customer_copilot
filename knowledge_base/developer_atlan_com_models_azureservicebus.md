# AzureServiceBus¶
(source: https://developer.atlan.com/models/azureservicebus/)
...
PropertiesazureServiceBusNamespaceNameazureServiceBusNamespaceQualifiedNameazureServiceBusSchemaQualifiedName
...
This is reference documentation covering the entire Atlan model. It isnotthe best place to start when trying to understand how to manage Azure Service Bus assets in Atlan. For that, we would suggest starting with either:
...
These attributes are specific to instances ofAzureServiceBus(and all of its subtypes).
