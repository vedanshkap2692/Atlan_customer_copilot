# ENTITY_DELETEevent type¶
(source: https://developer.atlan.com/events/types/entity_delete/)
...
ENTITY_DELETEevents are emitted whenever anassetis deleted in Atlan. This includes:
...
Atlan will emit 15,514ENTITY_DELETEevents — one for each of these assets (and the connection itself).

ENTITY_DELETE

The details of the deleted asset will be in themessage.entityportion of the event payload. Themessage.entity.deleteHandlerwill indicate the kind of delete:

message.entity

message.entity.deleteHandler

DEFAULTis an archival
