# Events when an asset is tagged¶
(source: https://developer.atlan.com/events/scenarios/asset-classify/)
...
Event triggersEvent triggersAsset is createdAsset is updatedAsset is deletedCustom metadata is addedCustom metadata is removedAsset is taggedAsset is taggedTable of contentsCLASSIFICATION_ADDAsset is untaggedLineage is created
...
Asset is taggedAsset is taggedTable of contentsCLASSIFICATION_ADD
...
When anassetis tagged in Atlan, the following event is emitted.
...
Atlan always emits aCLASSIFICATION_ADDevent when an asset is tagged.
