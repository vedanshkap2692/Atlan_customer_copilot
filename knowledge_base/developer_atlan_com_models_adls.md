# ADLS¶
(source: https://developer.atlan.com/models/adls/)
...
PropertiesadlsAccountQualifiedName
...
These attributes are specific to instances ofADLS(and all of its subtypes).
