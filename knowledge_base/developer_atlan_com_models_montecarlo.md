# MonteCarlo¶
(source: https://developer.atlan.com/models/montecarlo/)
...
This is reference documentation covering the entire Atlan model. It isnotthe best place to start when trying to understand managing Monte Carlo assets in Atlan. For that, we would suggest starting with either:
...
Following are the properties uniquely available onMonteCarloassets in Atlan.
