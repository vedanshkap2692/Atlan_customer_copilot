# Metabase¶
(source: https://developer.atlan.com/models/metabase/)
...
PropertiesmetabaseCollectionNamemetabaseCollectionQualifiedName
...
This is reference documentation covering the entire Atlan model. It isnotthe best place to start when trying to understand managing Metabase assets in Atlan. For that, we would suggest starting with either:
...
These attributes are specific to instances ofMetabase(and all of its subtypes).
