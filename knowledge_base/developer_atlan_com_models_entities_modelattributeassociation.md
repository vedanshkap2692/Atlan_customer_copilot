...
(source: https://developer.atlan.com/models/entities/modelattributeassociation/)
...
ModelsModelsModelAttributeModelAttributeAssociationModelAttributeAssociationTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)modelAttributeAssociationFrom (ModelAttribute)modelAttributeAssociationTo (ModelAttribute)ModelDataModelModelEntityModelEntityAssociationModelVersion

ModelAttribute

ModelAttributeAssociationModelAttributeAssociationTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)modelAttributeAssociationFrom (ModelAttribute)modelAttributeAssociationTo (ModelAttribute)

__
...
modelAttributeAssociationFrom (ModelAttribute)

modelAttributeAssociationTo (ModelAttribute)
...
This is a complete reference for theModelAttributeAssociationobject in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:
...
ModelAttributeAssociationinherits its attributes and relationships from these other types:
...
These attributes are inherited fromModelAttributeAssociation's supertypes (shown above):
...
These attributes are specific to instances ofModelAttributeAssociation(and all of its subtypes).
...
These relationships are inherited fromModelAttributeAssociation's supertypes:
...
These relationships are specific to instances ofModelAttributeAssociation(and all of its subtypes).
