...
(source: https://developer.atlan.com/patterns/create/azure_event_hub/)
...
Manage Azure Event Hub assetsManage Azure Event Hub assetsTable of contentsAsset structureConnectionAzureEventHubAzureEventHubConsumerGroupAvailable relationshipsAtlasGlossaryTermLinkReadmeProcess

Asset structureConnectionAzureEventHubAzureEventHubConsumerGroup
...
An Azure Event Hubconnectionrequires anameandqualifiedName. For creation, specific settings
are also required to distinguish it as an Azure Event Hub connection rather
than another type of connection. In addition,at least oneofadminRoles,adminGroups, oradminUsersmust be provided.
...
Set the type of connection toAZURE_EVENT_HUB.
...
of the workspace role(s).At least one ofadminRoles,adminGroups, oradminUsersmust be provided.
...
valadminRoleGuid=client.roleCache.getIdForName("\$admin")// (1)valconnection=Connection.creator(// (2)"event-hub-connection",// (3)AtlanConnectorType.AZURE_EVENT_HUB,// (4)listOf(adminRoleGuid),// (5)listOf("group2"),// (6)listOf("jsmith"))// (7).build()valresponse=connection.save(client)// (8)valconnectionQualifiedName=response.createdAssets[0].qualifiedName// (9)
...
{"entities":[{"typeName":"Connection",// (1)"attributes":{"name":"event-hub-connection",// (2)"connectorName":"azure-event-hub",// (3)"qualifiedName":"default/azure-event-hub/123456789",// (4)"category":"eventbus",// (5)"adminRoles":[// (6)"e7ae0295-c60a-469a-bd2c-fb903943aa02"],"adminGroups":[// (7)"group2"],"adminUsers":[// (8)"jsmith"]}}]}
...
TheconnectorNamemust be exactlyazure-event-hub.

connectorName

azure-event-hub

ThequalifiedNameshould follow the pattern:default/azure-event-hub/<epoch>, where<epoch>is the time in milliseconds at which the connection is being created.

qualifiedName

default/azure-event-hub/<epoch>

<epoch>

Thecategorymust beeventbus.
...
AnAzureEventHubrequires anameand aqualifiedName.
For creation, you also need to specify theconnectionQualifiedNameof the connection for the event hub.
...
AzureEventHubeventHub=AzureEventHub.creator(// (1)"myAzureEventHub",// (2)connectionQualifiedName)// (3).build();response=eventHub.save(client);// (4)eventHub=response.getResult(eventHub);// (5)

AzureEventHubeventHub=AzureEventHub.creator(// (1)"myAzureEventHub",// (2)connectionQualifiedName)// (3).build();response=eventHub.save(client);// (4)eventHub=response.getResult(eventHub);// (5)

Build up the minimum request to create a event hub.

Provide a human-readable name for your event hub.

Provide thequalifiedNameof the Azure Event Hub connection.

qualifiedName

Actually call Atlan to create the event hub. Because this operation will persist the asset in Atlan, you mustprovide it anAtlanClientthrough which to connect to the tenant.

AtlanClient

Retrieve the created event hub for use in subsequent creation calls.

171819202122

event_hub=AzureEventHub.creator(# (1)name="myAzureEventHub",# (2)connection_qualified_name=connection_qualified_name# (3))response=client.asset.save(event_hub)# (4)event_hub_qualifed_name=response.assets_created(asset_type=AzureEventHub)[0].qualified_name# (5)
...
Actually call Atlan to create the event hub.
...
vareventHub=AzureEventHub.creator(// (1)"myAzureEventHub",// (2)connectionQualifiedName)// (3).build()response=eventHub.save(client)// (4)eventHub=response.getResult(eventHub)// (5)
...
{"entities":[{"typeName":"AzureEventHub",// (1)"attributes":{"name":"myAzureEventHub",// (2)"qualifiedName":"default/azure-event-hub/123456789/topic/myAzureEventHub",// (3)"connectionQualifiedName":"default/azure-event-hub/123456789",// (4)"connectorName":"azure-event-hub"// (5)}}]}

{"entities":[{"typeName":"AzureEventHub",// (1)"attributes":{"name":"myAzureEventHub",// (2)"qualifiedName":"default/azure-event-hub/123456789/topic/myAzureEventHub",// (3)"connectionQualifiedName":"default/azure-event-hub/123456789",// (4)"connectorName":"azure-event-hub"// (5)}}]}

ThetypeNamemust be exactlyAzureEventHub.

typeName

AzureEventHub

Human-readable name for your event hub.

ThequalifiedNameshould follow the pattern:default/azure-event-hub/<epoch>/topic/<name>,
wheredefault/azure-event-hub/<epoch>is thequalifiedNameof the connection
for this event hub and<name>is the unique name for this event hub.

qualifiedName

default/azure-event-hub/<epoch>/topic/<name>
...
TheconnectionQualifiedNamemust be the exactqualifiedNameof the connection for this event hub.
...
AnAzureEventHubConsumerGrouprequires anameand aqualifiedName. For creation, you also need to specify the list ofeventHubQualifiedNamesof the event hubs that will contain the consumer group.
...
eventHubQualifiedNames

1718192021

AzureEventHubConsumerGroupconsumerGroup=AzureEventHubConsumerGroup.creator(// (1)"myEventHubConsumerGroup",// (2)List.of(eventHub))// (3).build();response=consumerGroup.save(client);// (4)
...
Provide the list of event hubs for this consumer group.

Actually call Atlan to create the consumer group. Because this operation will persist the asset in Atlan, you mustprovide it anAtlanClientthrough which to connect to the tenant.

AtlanClient

2324252627

consumer_group=AzureEventHubConsumerGroup.creator(# (1)name="myEventHubConsumerGroup",# (2)event_hub_qualified_names=[event_hub_qualified_name],# (3))response=client.asset.save(consumer_group)# (4)
...
Provide the list ofqualified_namesof the event hub for this consumer group.
...
valconsumerGroup=AzureEventHubConsumerGroup.creator(// (1)"myEventHubConsumerGroup",// (2)listOf(eventHub))// (3).build()response=consumerGroup.save(client)// (4)
...
ThequalifiedNameshould follow the pattern:default/azure-event-hub/<epoch>/consumer-group/<event_hub_name>/<name>, wheredefault/azure-event-hub/<epoch>is the qualifiedName 
of the connection that contains this consumer group and<name>is the unique name for this consumer group.

qualifiedName

default/azure-event-hub/<epoch>/consumer-group/<event_hub_name>/<name>

default/azure-event-hub/<epoch>

<name>

TheconnectionQualifiedNamemust be the exactqualifiedNameof the connection for this consumer group.
...
The list of event hubs in which this consumer group exists is embedded in thekafkaTopicsattribute.

kafkaTopics

ThetypeNamefor this embedded reference must beAzureEventHub.

typeName

AzureEventHub

To complete the reference, you must include auniqueAttributeswith thequalifiedNameof the event hub. Note: the event hub must already exist 
...
The list of event hub qualified names.
...
Every level of theAzure Event Hubstructure is anAsset,
