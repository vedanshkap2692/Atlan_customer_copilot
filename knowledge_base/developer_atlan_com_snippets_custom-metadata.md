...
(source: https://developer.atlan.com/snippets/custom-metadata/)
...
The custom metadata definition (sometimes referred to asset) itself, defined as aCustomMetadataDef

CustomMetadataDef

Theattributes(or properties) within that custom metadata set, each defined as anAttributeDef
...
Through Atlan's APIs, you cancreate your own custom metadatasets and attributes programmatically.

Once the structures exist, you can then alsochange custom metadata valueson assets themselves.
