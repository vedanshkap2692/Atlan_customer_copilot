# MaterialisedView¶
(source: https://developer.atlan.com/models/entities/materialisedview/)
...
Relational databasesRelational databasesDatabaseSchemaTableViewMaterialisedViewMaterialisedViewTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)dbtModels (DbtModel)dbtSources (DbtSource)dbtTests (DbtTest)sqlDBTSources (DbtSource)sqlDbtModels (DbtModel)columns (Column)atlanSchema (Schema)ColumnQueryTablePartitionCalculationViewBigqueryTagDatabricksUnityCatalogTagSnowflakeDynamicTableSnowflakePipeSnowflakeStreamSnowflakeTagProcedureFunctionSQL
...
MaterialisedViewMaterialisedViewTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)dbtModels (DbtModel)dbtSources (DbtSource)dbtTests (DbtTest)sqlDBTSources (DbtSource)sqlDbtModels (DbtModel)columns (Column)atlanSchema (Schema)

__
...
This is a complete reference for theMaterialisedViewobject in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:
...
MaterialisedViewinherits its attributes and relationships from these other types:
...
These attributes are inherited fromMaterialisedView's supertypes (shown above):
...
These attributes are specific to instances ofMaterialisedView(and all of its subtypes).
...
These relationships are inherited fromMaterialisedView's supertypes:
...
These relationships are specific to instances ofMaterialisedView(and all of its subtypes).
