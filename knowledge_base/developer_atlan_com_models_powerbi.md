# Power BIPowerBI¶
(source: https://developer.atlan.com/models/powerbi/)
...
PropertiespowerBIEndorsementpowerBIFormatStringpowerBIIsHiddenpowerBITableQualifiedName
...
This is reference documentation covering the entire Atlan model. It isnotthe best place to start when trying to understand managing Power BI assets in Atlan. For that, we would suggest starting with either:
...
These attributes are specific to instances ofPowerBI(and all of its subtypes).
