# Matillion¶
(source: https://developer.atlan.com/models/matillion/)
...
This is reference documentation covering the entire Atlan model. It isnotthe best place to start when trying to understand managing Matillion assets in Atlan. For that, we would suggest starting with either:
...
These attributes are specific to instances ofMatillion(and all of its subtypes).
