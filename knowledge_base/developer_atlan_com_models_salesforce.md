# Salesforce¶
(source: https://developer.atlan.com/models/salesforce/)
...
PropertiesapiNameorganizationQualifiedName
...
This is reference documentation covering the entire Atlan model. It isnotthe best place to start when trying to understand managing Salesforce assets in Atlan. For that, we would suggest starting with either:
...
These attributes are specific to instances ofSalesforce(and all of its subtypes).
