# ModelEntity¶
(source: https://developer.atlan.com/models/entities/modelentity/)
...
ModelsModelsModelAttributeModelAttributeAssociationModelDataModelModelEntityModelEntityTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)modelEntityAttributes (ModelAttribute)modelEntityGeneralizationEntity (ModelEntity)modelEntityImplementedByAssets (Catalog)modelEntityMappedFromEntities (ModelEntity)modelEntityMappedToEntities (ModelEntity)modelEntityRelatedFromEntities (ModelEntityAssociation)modelEntityRelatedToEntities (ModelEntityAssociation)modelEntitySpecializationEntities (ModelEntity)modelVersions (ModelVersion)ModelEntityAssociationModelVersion
...
ModelEntityModelEntityTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)modelEntityAttributes (ModelAttribute)modelEntityGeneralizationEntity (ModelEntity)modelEntityImplementedByAssets (Catalog)modelEntityMappedFromEntities (ModelEntity)modelEntityMappedToEntities (ModelEntity)modelEntityRelatedFromEntities (ModelEntityAssociation)modelEntityRelatedToEntities (ModelEntityAssociation)modelEntitySpecializationEntities (ModelEntity)modelVersions (ModelVersion)

__
...
modelEntityAttributes (ModelAttribute)

modelEntityGeneralizationEntity (ModelEntity)

modelEntityImplementedByAssets (Catalog)

modelEntityMappedFromEntities (ModelEntity)

modelEntityMappedToEntities (ModelEntity)

modelEntityRelatedFromEntities (ModelEntityAssociation)

modelEntityRelatedToEntities (ModelEntityAssociation)

modelEntitySpecializationEntities (ModelEntity)
...
This is a complete reference for theModelEntityobject in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:
...
ModelEntityinherits its attributes and relationships from these other types:
...
These attributes are inherited fromModelEntity's supertypes (shown above):
...
These attributes are specific to instances ofModelEntity(and all of its subtypes).
...
These relationships are inherited fromModelEntity's supertypes:
...
These relationships are specific to instances ofModelEntity(and all of its subtypes).
