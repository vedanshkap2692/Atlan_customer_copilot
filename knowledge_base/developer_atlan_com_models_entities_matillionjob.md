# MatillionJob¶
(source: https://developer.atlan.com/models/entities/matillionjob/)
...
MatillionMatillionMatillionComponentMatillionGroupMatillionJobMatillionJobTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)matillionComponents (MatillionComponent)matillionProject (MatillionProject)MatillionProject

MatillionComponent

MatillionGroup

MatillionJobMatillionJobTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)matillionComponents (MatillionComponent)matillionProject (MatillionProject)

__
...
matillionComponents (MatillionComponent)

matillionProject (MatillionProject)
...
This is a complete reference for theMatillionJobobject in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:
...
MatillionJobinherits its attributes and relationships from these other types:
...
These attributes are inherited fromMatillionJob's supertypes (shown above):
...
These attributes are specific to instances ofMatillionJob(and all of its subtypes).
...
These relationships are inherited fromMatillionJob's supertypes:
...
These relationships are specific to instances ofMatillionJob(and all of its subtypes).
