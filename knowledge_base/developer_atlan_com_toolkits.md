# Toolkits¶
(source: https://developer.atlan.com/toolkits/#__consent)
...
Get startedInstall pklConfigure in an IDE
...
In thisToolkitssection you will find details about these frameworks.
...
PackagesYour integration or automation, available in Atlan's marketplace of packages.Bundle for reuse
...
TypedefsYour unique metadata modeled and available as first-class objects in Atlan.Design custom assets
...
TestingYour guide to write robust, reusable integration tests for connectors and utilities in Atlan.Test your connector and utilities

Testing

Your guide to write robust, reusable integration tests for connectors and utilities in Atlan.

Test your connector and utilities
...
Our toolkits are mostly built onPkl, a configuration language developed by Apple.
...
To get started, you'll need to installpkland configure its plugin in your favorite IDE.
...
curl-L-opklhttps://github.com/apple/pkl/releases/download/0.28.1/pkl-linux-aarch64
chmod+xpkl

curl-L-opklhttps://github.com/apple/pkl/releases/download/0.28.1/pkl-linux-aarch64
chmod+xpkl

curl-L-opklhttps://github.com/apple/pkl/releases/download/0.28.1/pkl-linux-amd64
chmod+xpkl

curl-L-opklhttps://github.com/apple/pkl/releases/download/0.28.1/pkl-linux-amd64
chmod+xpkl

curl-L-opklhttps://github.com/apple/pkl/releases/download/0.28.1/pkl-alpine-linux-amd64
chmod+xpkl

curl-L-opklhttps://github.com/apple/pkl/releases/download/0.28.1/pkl-alpine-linux-amd64
chmod+xpkl

curl-L-ojpklhttps://repo1.maven.org/maven2/org/pkl-lang/pkl-cli-java/0.28.1/jpkl
chmod+xjpkl

curl-L-ojpklhttps://repo1.maven.org/maven2/org/pkl-lang/pkl-cli-java/0.28.1/jpkl
chmod+xjpkl

Note the CLI command isjpkl

jpkl

On Windows (or any other platform using the Java executable), the command isjpklrather thanpkl.
...
Then configurepklin your favorite IDE:

pkl

For now you'll have to rely onPkl's own instructions.
