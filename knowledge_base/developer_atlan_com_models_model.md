...
(source: https://developer.atlan.com/models/model/)
...

...
This is reference documentation covering the entire Atlan model. It isnotthe best place to start when trying to understand how to manage data model assets in Atlan. For that, we would suggest starting with the manage data model assets pattern (coming soon).
...
These attributes are unique to instances ofModel(and all of its subtypes).
