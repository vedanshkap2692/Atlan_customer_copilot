# AnaplanDimension¶
(source: https://developer.atlan.com/models/entities/anaplandimension/)
...
AnaplanAnaplanAnaplanWorkspaceAnaplanAppAnaplanPageAnaplanModelAnaplanModuleAnaplanListAnaplanSystemDimensionAnaplanDimensionAnaplanDimensionTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)anaplanColumnViews (AnaplanView)anaplanLineItems (AnaplanLineItem)anaplanModel (AnaplanModel)anaplanPageViews (AnaplanView)anaplanRowViews (AnaplanView)AnaplanLineItemAnaplanView
...
AnaplanDimensionAnaplanDimensionTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)anaplanColumnViews (AnaplanView)anaplanLineItems (AnaplanLineItem)anaplanModel (AnaplanModel)anaplanPageViews (AnaplanView)anaplanRowViews (AnaplanView)
...
anaplanColumnViews (AnaplanView)

anaplanLineItems (AnaplanLineItem)

anaplanModel (AnaplanModel)

anaplanPageViews (AnaplanView)

anaplanRowViews (AnaplanView)
...
This is a complete reference for theAnaplanDimensionobject in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:
...
AnaplanDimensioninherits its attributes and relationships from these other types:
...
These attributes are inherited fromAnaplanDimension's supertypes (shown above):
...
These relationships are inherited fromAnaplanDimension's supertypes:
...
These relationships are specific to instances ofAnaplanDimension(and all of its subtypes).
