# Google model¶
(source: https://developer.atlan.com/models/google/)
...
PropertiesgoogleLabelsgoogleLocationgoogleLocationTypegoogleProjectIdgoogleProjectNamegoogleProjectNumbergoogleServicegoogleTags
...
This is reference documentation covering the entire Atlan model. It isnotthe best place to start when trying to understand integrating Google assets with Atlan. For that, we would suggest starting with either:

Themanage Google Cloud Storage assets pattern

Themanage Google Data Studio assets pattern
...
These attributes are specific to instances ofGoogle(and all of its subtypes).
