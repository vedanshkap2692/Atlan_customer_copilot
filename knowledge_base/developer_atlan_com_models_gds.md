...
(source: https://developer.atlan.com/models/gds/)
...
This is reference documentation covering the entire Atlan model. It isnotthe best place to start when trying to understand managing Data Studio assets in Atlan. For that, we would suggest starting with themanage Google Data Studio assets pattern.
