# LookerLook¶
(source: https://developer.atlan.com/models/entities/lookerlook/)
...
LookerLookerLookerDashboardLookerExploreLookerFieldLookerFolderLookerLookLookerLookTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)dashboard (LookerDashboard)fields (LookerField)folder (LookerFolder)model (LookerModel)query (LookerQuery)tile (LookerTile)LookerModelLookerProjectLookerQueryLookerTileLookerView
...
LookerLookLookerLookTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)dashboard (LookerDashboard)fields (LookerField)folder (LookerFolder)model (LookerModel)query (LookerQuery)tile (LookerTile)

__
...
This is a complete reference for theLookerLookobject in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:
...
LookerLookinherits its attributes and relationships from these other types:
...
These attributes are inherited fromLookerLook's supertypes (shown above):
...
These attributes are specific to instances ofLookerLook(and all of its subtypes).
...
These relationships are inherited fromLookerLook's supertypes:
...
These relationships are specific to instances ofLookerLook(and all of its subtypes).
