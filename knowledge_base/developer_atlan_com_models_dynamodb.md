# DynamoDB model¶
(source: https://developer.atlan.com/models/dynamodb/)
...
PropertiesdynamoDBPartitionKeydynamoDBReadCapacityUnitsdynamoDBSortKeydynamoDBStatusdynamoDBWriteCapacityUnits
...
This is a complete reference for theDynamoDBobject in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:
...
These attributes are specific to instances ofDynamoDB(and all of its subtypes).
