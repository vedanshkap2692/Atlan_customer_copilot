# CogniteAsset¶
(source: https://developer.atlan.com/models/entities/cogniteasset/)
...
CogniteCogniteCognite3DModelCogniteAssetCogniteAssetTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)cognite3dmodels (Cognite3DModel)cogniteEvents (CogniteEvent)cogniteFiles (CogniteFile)cogniteSequences (CogniteSequence)cogniteTimeseries (CogniteTimeSeries)CogniteEventCogniteFileCogniteSequenceCogniteTimeseries

Cognite3DModel

CogniteAssetCogniteAssetTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)cognite3dmodels (Cognite3DModel)cogniteEvents (CogniteEvent)cogniteFiles (CogniteFile)cogniteSequences (CogniteSequence)cogniteTimeseries (CogniteTimeSeries)
...
cognite3dmodels (Cognite3DModel)

cogniteEvents (CogniteEvent)

cogniteFiles (CogniteFile)

cogniteSequences (CogniteSequence)
...
This is a complete reference for theCogniteAssetobject in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:
...
CogniteAssetinherits its attributes and relationships from these other types:
...
These attributes are inherited fromCogniteAsset's supertypes (shown above):
...
These relationships are inherited fromCogniteAsset's supertypes:
...
These relationships are specific to instances ofCogniteAsset(and all of its subtypes).
