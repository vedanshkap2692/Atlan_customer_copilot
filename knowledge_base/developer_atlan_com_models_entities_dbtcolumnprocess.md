# DbtColumnProcess¶
(source: https://developer.atlan.com/models/entities/dbtcolumnprocess/)
...
dbtdbtDbtColumnProcessDbtColumnProcessTable of __ (AdfActivity)airflowTasks (AirflowTask)columnProcesses (ColumnProcess)fivetranConnector (FivetranConnector)inputs (Catalog)matillionComponent (MatillionComponent)outputs (Catalog)powerBIDataflow (PowerBIDataflow)sparkJobs (SparkJob)anomaloChecks (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)process (Process)DbtMetricDbtModelDbtModelColumnDbtProcessDbtSourceDbtTagDbtTest

DbtColumnProcessDbtColumnProcessTable of __ (AdfActivity)airflowTasks (AirflowTask)columnProcesses (ColumnProcess)fivetranConnector (FivetranConnector)inputs (Catalog)matillionComponent (MatillionComponent)outputs (Catalog)powerBIDataflow (PowerBIDataflow)sparkJobs (SparkJob)anomaloChecks (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)process (Process)

__
...
This is a complete reference for theDbtColumnProcessobject in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:
...
DbtColumnProcessinherits its attributes and relationships from these other types:
...
These attributes are inherited fromDbtColumnProcess's supertypes (shown above):
...
These attributes are specific to instances ofDbtColumnProcess(and all of its subtypes).
...
These relationships are inherited fromDbtColumnProcess's supertypes:
