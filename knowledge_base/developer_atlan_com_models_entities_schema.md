# Schema¶
(source: https://developer.atlan.com/models/entities/schema/)
...
Relational databasesRelational databasesDatabaseSchemaSchemaTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)dbtModels (DbtModel)dbtSources (DbtSource)dbtTests (DbtTest)sqlDBTSources (DbtSource)sqlDbtModels (DbtModel)calculationViews (CalculationView)database (Database)functions (Function)materialisedViews (MaterialisedView)procedures (Procedure)snowflakeDynamicTables (SnowflakeDynamicTable)snowflakePipes (SnowflakePipe)snowflakeStreams (SnowflakeStream)snowflakeTags (SnowflakeTag)tables (Table)views (View)TableViewMaterialisedViewColumnQueryTablePartitionCalculationViewBigqueryTagDatabricksUnityCatalogTagSnowflakeDynamicTableSnowflakePipeSnowflakeStreamSnowflakeTagProcedureFunctionSQL

Database

SchemaSchemaTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)dbtModels (DbtModel)dbtSources (DbtSource)dbtTests (DbtTest)sqlDBTSources (DbtSource)sqlDbtModels (DbtModel)calculationViews (CalculationView)database (Database)functions (Function)materialisedViews (MaterialisedView)procedures (Procedure)snowflakeDynamicTables (SnowflakeDynamicTable)snowflakePipes (SnowflakePipe)snowflakeStreams (SnowflakeStream)snowflakeTags (SnowflakeTag)tables (Table)views (View)

__
...
materialisedViews (MaterialisedView)

procedures (Procedure)

snowflakeDynamicTables (SnowflakeDynamicTable)

snowflakePipes (SnowflakePipe)

snowflakeStreams (SnowflakeStream)

snowflakeTags (SnowflakeTag)
...
This is a complete reference for theSchemaobject in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:
...
Schemainherits its attributes and relationships from these other types:
...
These attributes are inherited fromSchema's supertypes (shown above):
...
These attributes are specific to instances ofSchema(and all of its subtypes).
...
Uses a different name in SDKsviewCountview_count
...
These relationships are inherited fromSchema's supertypes:
...
These relationships are specific to instances ofSchema(and all of its subtypes).
...
Uses a different name in SDKsmaterializedViewsmaterialized_views

Uses a different name in SDKs

materializedViewsmaterialized_views
