# MetabaseDashboard¶
(source: https://developer.atlan.com/models/entities/metabasedashboard/)
...
MetabaseMetabaseMetabaseCollectionMetabaseDashboardMetabaseDashboardTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)metabaseCollection (MetabaseCollection)metabaseQuestions (MetabaseQuestion)MetabaseQuestion

MetabaseCollection

MetabaseDashboardMetabaseDashboardTable of __ (AnomaloCheck)application (Application)applicationField (ApplicationField)meanings (AtlasGlossaryTerm)dataContractLatest (DataContract)dataContractLatestCertified (DataContract)files (File)inputPortDataProducts (DataProduct)links (Link)mcIncidents (MCIncident)mcMonitors (MCMonitor)metrics (Metric)outputPortDataProducts (DataProduct)readme (Readme)schemaRegistrySubjects (SchemaRegistrySubject)sodaChecks (SodaCheck)userDefRelationshipFrom (Referenceable)userDefRelationshipTo (Referenceable)inputToAirflowTasks (AirflowTask)inputToProcesses (Process)inputToSparkJobs (SparkJob)modelImplementedAttributes (ModelAttribute)modelImplementedEntities (ModelEntity)outputFromAirflowTasks (AirflowTask)outputFromProcesses (Process)outputFromSparkJobs (SparkJob)metabaseCollection (MetabaseCollection)metabaseQuestions (MetabaseQuestion)

__
...
metabaseQuestions (MetabaseQuestion)
...
This is a complete reference for theMetabaseDashboardobject in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:
...
MetabaseDashboardinherits its attributes and relationships from these other types:
...
These attributes are inherited fromMetabaseDashboard's supertypes (shown above):
...
These attributes are specific to instances ofMetabaseDashboard(and all of its subtypes).
...
These relationships are inherited fromMetabaseDashboard's supertypes:
...
These relationships are specific to instances ofMetabaseDashboard(and all of its subtypes).
