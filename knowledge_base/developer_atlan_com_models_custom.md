# Custom¶
(source: https://developer.atlan.com/models/custom/)
...
This is a complete reference for theCustomobject in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:
...
Custominherits its attributes and relationships from these other types:
...
These attributes are specific to instances ofCustom(and all of its subtypes).
