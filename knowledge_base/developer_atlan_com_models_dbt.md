# dbt model¶
(source: https://developer.atlan.com/models/dbt/)
...

...
This is reference documentation covering the entire Atlan model. It isnotthe best place to start when trying to understand integrating dbt metadata with Atlan. For that, we would suggest starting with thecommon asset actions snippets.
...
These attributes are specific to instances ofDbt(and all of its subtypes).
