# Event handling¶
(source: https://developer.atlan.com/patterns/events/)
...
Currently in Atlan, you cancreate webhooksthat will send all metadata activity to a target URL of your choice.

In this section you'll find common scenarios to write such a target to handle these events:

Webhook <> Lambdahandling events through an AWS Lambda function
