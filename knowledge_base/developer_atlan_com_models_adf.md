# Azure Data Factory model¶
(source: https://developer.atlan.com/models/adf/)
...
PropertiesadfAssetFolderPathadfFactoryName
...
This is reference documentation covering the entire Atlan model. It isnotthe best place to start when trying to understand how to manage Azure Data Factory assets in Atlan.
...
These attributes are unique to instances ofADF(and all of its subtypes).
