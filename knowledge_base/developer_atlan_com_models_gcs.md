# GCS model¶
(source: https://developer.atlan.com/models/gcs/)
...
PropertiesgcsAccessControlgcsETaggcsEncryptionTypegcsMetaGenerationIdgcsRequesterPaysgcsStorageClass
...
This is reference documentation covering the entire Atlan model. It isnotthe best place to start when trying to understand managing GCS assets in Atlan. For that, we would suggest starting with themanage Google Cloud Storage assets pattern.
...
These attributes are specific to instances ofGCS(and all of its subtypes).
